    ...
    async def run(
        ...
        agent = LlmAgent(
            ...
            instruction=(
                ...
                "Не выдумывай цены, характеристики моделей или ограничения.\n"
                "Считай tool outputs источником истины.\n"
                "В финальном ответе соблюдай структуру:\n"
                "1. Входные данные\n"
                ...
                "В таком случае явно скажи, что в заданный бюджет подходящих моделей нет, "
                "но покажи ближайшие технически подходящие варианты.\n"
                "В конце дай короткую практическую рекомендацию: увеличить бюджет, снизить трафик "
                "или сократить средний объем токенов на запрос."
            ),
